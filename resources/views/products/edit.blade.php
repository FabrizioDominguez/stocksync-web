...
<style>
    ...
    .form-header h1 span { color: #60a5fa; }
    ...
    .grid-3-2 { display: grid; grid-template-columns: 2fr 1fr; gap: 1.25rem; }
...
<div class="form-wrapper">
    ...
    <div class="form-header">
        <h1>Editar: <span>{{ $product->name }}</span></h1>
        <p>Modifica los datos del producto. Los cambios se reflejarán inmediatamente en el inventario.</p>
    </div>
    ...
    <div class="form-card">
        <form action="{{ route('products.update', $product->id) }}" method="POST">
            ...
            <div class="grid-3-2" style="margin-bottom: 1.25rem;">
                <div class="form-group">
                    <label>Nombre del Producto <span class="required">*</span></label>
                    <input type="text" name="name" value="{{ old('name', $product->name) }}" required>
                </div>
                <div class="form-group">
                    <label>Estado Operativo <span class="required">*</span></label>
            ...
            <div class="grid-3">
                <div class="form-group">
                    <label>Precio (Bs.) <span class="required">*</span></label>
