<x-app-layout>
    <div style="max-width: 800px; margin: 2rem auto; padding: 0 1.5rem;">
        ...
        <div style="margin-bottom: 2rem;">
            ...
            <h1 style="font-size: 1.875rem; font-weight: 800; color: #fff; margin: 1rem 0 0 0; letter-spacing: -0.025em;">Nueva Categoría</h1>
        </div>
            ...
            <form action="{{ route('categories.store') }}" method="POST">
                ...
                <div style="margin-bottom: 2rem;">
                    ...
                    <textarea name="description" id="description" rows="3"
                              ...
                              onfocus="this.style.borderColor='#3b82f6'; this.style.boxShadow='0 0 0 2px rgba(59,130,246,0.2)'"
                              onblur="this.style.borderColor='rgba(255,255,255,0.1)'; this.style.boxShadow='none'"
                              placeholder="Breve descripción de los productos de esta categoría...">{{ old('description') }}</textarea>
                    @error('description')
                        <p style="color: #f87171; font-size: 0.75rem; margin-top: 0.5rem;">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div style="display: flex; justify-content: flex-end; gap: 1rem;">
                    ...
                    <button type="submit" style="display: inline-flex; align-items: center; justify-content: center; padding: 10px 24px; border-radius: 8px; background: linear-gradient(135deg, #3b82f6, #6366f1); color: white; font-weight: 600; border: none; cursor: pointer; box-shadow: 0 4px 14px rgba(59,130,246,0.4); transition: all 0.2s;" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform='none'">
                        Guardar Categoría
                    </button>
                </div>
            </form>
